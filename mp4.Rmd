...
annotate("text", x = 2012, y = 0.3, label = 
"Wonder Woman", size = 3, family = "sans", color = "black") +  annotate("text", x = 2007, y = 0.2, label = "August Rush", size = 3, family = "sans", color = "black") + annotate("text", x = 1997, y = 0.15, label = "The Peacemaker", size = 3, family = "sans", color = "black") + annotate("text", x = 1987, y = 0.2, label = "Ishtar", size = 3, family = "sans", color = "black") + annotate("text", x = 1978, y = 0.13, label = "Moment By Moment", size = 3, family = "sans", color = "black") 
