...
female_movies <- function(s) {
            ...
            JOIN imdb.cast_info AS ci ON n.id = ci.person_id
            WHERE mi1.info_type_id = 107
                    AND role_id = 8
                    AND gender = 'f'
                    AND mi2.info_type_id = 8
...
female_mov <- female_movies(1977)
gross_new <- gross_female(female_mov)
gross_new

#top movie directed by women in 1967 = Guess Who's Coming to Dinner, Bonnie and Clyde, Casino Royale

#top movie directed by women in 1977 = Close Encounters of the Third Kind, Pete's Dragon, Annie Hall

#top movie directed by women in 1987 = 

#top movie directed by women in 1997 =

#top movie directed by women in 2007 =

#top movie directed by women in 2017 = 
